...
> **最后更�?*�?026-08-08  
> **当前版本线**：`1.2.23` / code `143`（以 `apps/tauri` 为准） 
...
## 3. 当前版本对照（以源码为准�?
> Tag（如 `v1.2.23`）是发版列车号；用户看到的版本以各端源码为准。下表按 **2026-08-13** 核对�?
| �?| 用户可见版本 | 版本�?| 改哪�?|
|----|--------------|--------|--------|
| **Android / Windows / macOS / Linux** | `1.2.23` | `143` | **统一**：`apps/tauri/package.json`、`src-tauri/tauri.conf.json`、`src/lib/app-meta.ts`；`Cargo.toml` 一�?|
| **iPhone** | `1.2.23` | `143` | `apps/tauri/platforms/ios/project.yml` |
| **发版 Tag** | `v1.2.23` | �?| �?Git Tag |
