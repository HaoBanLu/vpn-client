...
最后核对：**2026-09-20**（版本线 `1.2.33` / code `153`）

| 功能 / 变更 | 状态 | 日期 | 备注 |
|-------------|------|------|------|
| 发版 1.2.33 / code 153 | ✅ | 2026-09-20 | 节点通讯录式列表；连接态红字/误拆隧修复；通知分行指标；升级前台 60s 复检。Tag `v1.2.33` |
...
| 节点页通讯录式列表 | ✅ | 2026-09-20 | 按地区粘性分区标题 + 右侧索引跳转；通栏白底铺满；进页自动测速；整行可点连接 |
